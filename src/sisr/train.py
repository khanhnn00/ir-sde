...
import src.sisr.options as option
from src.sisr.models import create_model
...
def main():
    ...
    parser.add_argument("-opt", type=str, help="Path to option YMAL file.", default="ir-sde.yml")
    parser.add_argument(
    ...
    args.opt = os.path.join('src/sisr/options/train/', args.opt)
