...
import src.sisr.models.lr_scheduler as lr_scheduler
import src.sisr.models.networks as networks
from src.sisr.models.optimizer import Lion

from src.sisr.models.modules.loss import MatchingLoss

from src.sisr.models.base_model import BaseModel
...
class DenoisingModel(BaseModel):
    def __init__(self, opt):
        ...
        if self.is_train:
            ...
            # schedulers
            print(train_opt["restarts"])
            print(train_opt["restart_weights"])
            print(train_opt["clear_state"])
